...
</style><body style="background:url('img/intro-bg.jpg'); background-size:100%">
...
<div class="container2" style="float: center;">
    ...
    <hr>
      <form method="post" action="addshop.php">
        ...
        <input type="text" id="street" name="place" placeholder="Place name..">

<label for="fname">Name of shop</label>
        <input type="text" id="fname" name="name" placeholder="Its name..">
     ...
     -->
    	<button type="submit" class="btn btn-danger" name="add_shop" onclick="history.go(-1)"> Add </button>
    	</form><br><br>
